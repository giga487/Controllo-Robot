function [a3,a2,a1,a0] = createTraj3(theta0_m,thetaf_m,thetad0_m,thetadf_m,tstart,tfinal)
    ...
    for i = 1:1:size(theta0_m,1)
        ...
        a0(i,1) = theta0;
        a1(i,1) = thetad0;
        a2(i,1) = (-3 * (theta0 - thetaf) - (2 * thetad0+thetadf )*T)/ T ^ 2;
        a3(i,1) = (2 * (theta0 - thetaf) + (thetad0+thetadf )*T)/ T ^ 3;
    end
