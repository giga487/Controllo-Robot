%19_7 Tavola 3 Amato, no articolo
...
syms E_fun(x1,x2,x3,x4,x5,x6,x7) G_fun(x1,x2,x3,x4,x5,x6,x7)
E_fun(x1,x2,x3,x4,x5,x6,x7) = E;
E_00 = E_fun(0,0,x3,0,0,0,0)
rank(E)

G_fun(x1,x2,x3,x4,x5,x6,x7) = G;
G_00 = G_fun(0,0,x3,0,x5,x6,x7)

%%
syms d_psi(x1,x2,x3,x4,x5,x6,x7)
...
d_psi(x1,x2,x3,x4,x5,x6,x7) = d_psi;

d_00 = d_psi(0,0,x3,x4,0,0,x7)
