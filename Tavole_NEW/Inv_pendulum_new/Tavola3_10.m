...
Lft_h1 = jacobian(h1,x)*f_tilde;
Lft_h2 = jacobian(h2,x)*f_tilde;
Lg1_h1 = jacobian(h1,x)*g1_tilde
Lg2_h1 = jacobian(h1,x)*g2_tilde
Lg1_h2 = jacobian(h2,x)*g1_tilde
Lg2_h2 = jacobian(h2,x)*g2_tilde

Lft2_h1 = jacobian(Lft_h1,x)*f_tilde;
Lft2_h2 = jacobian(Lft_h2,x)*f_tilde;
Lg1_Lft_h1 = jacobian(Lft_h1,x)*g1_tilde
Lg2_Lft_h1 = jacobian(Lft_h1,x)*g2_tilde
Lg1_Lft_h2 = jacobian(Lft_h2,x)*g1_tilde
Lg2_Lft_h2 = jacobian(Lft_h2,x)*g2_tilde

Lft3_h1 = jacobian(Lft2_h1,x)*f_tilde;
Lft3_h2 = jacobian(Lft2_h2,x)*f_tilde;
Lg1_Lft2_h1 = jacobian(Lft2_h1,x)*g1_tilde
Lg2_Lft2_h1 = jacobian(Lft2_h1,x)*g2_tilde
Lg1_Lft2_h2 = jacobian(Lft2_h2,x)*g1_tilde
Lg2_Lft2_h2 = jacobian(Lft2_h2,x)*g2_tilde

E = [Lg1_Lft2_h1,Lg2_Lft2_h1;
     Lg1_Lft2_h2,Lg2_Lft2_h2]
 
syms E_fun(x1,x2,x3,x4,x5,x6,x7,x8)
E_fun(x1,x2,x3,x4,x5,x6,x7,x8) = E;
E_0 = E_fun(0,0,0,x4,0,x6,0,0)
