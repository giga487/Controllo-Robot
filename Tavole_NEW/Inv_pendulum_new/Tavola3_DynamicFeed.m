...
E3 = [Lg1Lf2h1,Lg2Lf2h1
      Lg1Lfh2,Lg2Lfh2]
  
E4 = [Lg1Lf2h1,Lg2Lf2h1;
      Lg1Lf3h2,Lg2Lf3h2]
%%
syms E2_fun(x1,x2,x3,x4,x5,x6,x7) E3_fun(x1,x2,x3,x4,x5,x6,x7) E4_fun(x1,x2,x3,x4,x5,x6,x7)
E2_fun(x1,x2,x3,x4,x5,x6,x7) = E2;
E2_f = E2_fun(0,0,0,0,0,x6,0) 
rank(E2_f)
%detE3_fun(x1,x2,x3,x4,x5,x6,x7) = det(E3);
%E3_f = detE3_fun(0,0,x3,0,0,x6,0) 
% E4_fun(x1,x2,x3,x4,x5,x6,x7) = (E4);
% E4_f = vpa(E4_fun(0,0,0,x4,x5,0,0))
% rank(E4_f)

%% Cerco il 7 elemento della dynamic 
...
syms d_psi_fu(x1,x2,x3,x4,x5,x6,x7)
d_psi_fu(x1,x2,x3,x4,x5,x6,x7) = d_psi;
d_psi_try = d_psi_fu(0,0,0,0,0,x6,0)
rank(d_psi_try)

Gamma = [Lf2h1;
         Lf3h2]
%      
% syms invE2_fun(x1,x2,x3,x4,x5,x6,x7)
% invE2_fun(x1,x2,x3,x4,x5,x6,x7) = inv(E2);
% invE2_f = invE2_fun(0,0,0,0,0,x6,0)
% det(invE2_f)