...
% IL sistema è accessibile solo se x6 diversa da 0.
%% CONTROLLABILTA
%se l'accessibilità è garantita tramite il teorema di Chow
%devo trovare una delle condizione che garantiscono l'accessibilità in caso
%di controllabilità.
...
Rank_dO = rank(dO)
%Il rank della codistribuzione è 5 con le uscite prese per la feedback
%linearization.
...
%Il rank della codistribuzione è 7 per tutti i valori di x
%con le uscite x1 x2, il sistema è osservabile
